        ...
        <div class="col-xs-12">
                        ...
                        <tbody>
                            <tr> 
                                ...
                                <td><button class="delete btn btn-danger" data-nome="<?php echo $linha["nome"]; ?>" data-id="<?php echo $linha["id_titulo"]; ?>"data-target="#myModal">Excluir</a>
                                    ...
                                    <td><a class="btn btn-default"href="editar-titulospagar.php?id_titulo=<?php echo $linha["id_titulo"]; ?>&nome=<?php echo $linha["nome"]; ?>&valordocumento=<?php echo $linha["valor_documento"]; ?>&descricao=<?php echo $linha["descricao"]; ?>&documento=<?php echo $linha["documento"]; ?>&situacao=<?php echo $linha["situacao"]; ?>&parcela=<?php echo $linha["parcela"]; ?>&dataoperacao=<?php echo $linha["data_operacao"]; ?>&datavencimento=<?php echo $linha["forma_pagamento"]; ?>" >Editar</a></td>
                            </tr>
                        </tbody>
                        <?php                            
                    endforeach;
            ...
            <script>
                $('.delete').on('click', function () {
                    ...
                    $('a.delete-yes').attr('href', '../../controller/TituloPagarController.php?acao=excluirtitulo&id=' + id); // mudar dinamicamente o link, href do botão confirmar da modal
